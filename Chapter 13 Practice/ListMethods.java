...
public class ListMethods
{
    ...
    public static ArrayList<Integer> reverseList(ArrayList<Integer> tlist){
        ArrayList<Integer> list = ListMethods.deepCloe(tList);
    ...
    public static ArrayList<Integer> even(ArrayList<Integer> tList){
        ArrayList<Integer> list = ListMethods.deepClose(tlist);
    ...
    public static ArrayList<Integer> merge(ArrayList<Integer> tList1){
        ...
        if(list1.size()==0){
            ...
            if(listElement1.compareTo(listElement2)<0){
                listElement2 = list2.remove(list2.size()-1);
