...
public class TreeFractalViewer implements ActionListener
{
    ...
    private TreeFractalPanel drawing;
    ...
    public TreeFractalViewer()
    {
        ...
        titleLabel = new JLabel ("Tree Fractal");
        ...
        drawing = new TreeFractalPanel (1);
